...
export const CalendarScreen = ({ navigation }) => {
  ...
  const onDateSelect = (date) => setSelectedDate(date);
  ...
  const headerStyles = {
    ...
    sideLeft: { width: 72, flexDirection: "row", alignItems: "center" },
    sideRight: {
      width: 72,
      flexDirection: "row",
      alignItems: "center",
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.background }}>
      ...
      <View style={headerStyles.container}>
        <View style={headerStyles.row}>
          <View style={headerStyles.sideLeft}>
            <TouchableOpacity
          ...
          <View style={headerStyles.sideRight}>
            {isEditableDate ? (
              <TouchableOpacity onPress={openEdit}>
                <Text style={headerStyles.editLink}>Edit</Text>
              </TouchableOpacity>
            ) : null}
          </View>
        </View>
